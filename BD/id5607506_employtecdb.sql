...
-- -----------------------------------------------------
-- Schema id5607506_employtecdb
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `id5607506_employtecdb` ;

-- -----------------------------------------------------
-- Schema id5607506_employtecdb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `id5607506_employtecdb` DEFAULT CHARACTER SET utf8 ;
USE `id5607506_employtecdb` ;

-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`area_ti`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`area_ti` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`area_ti` (
  `cd_areaTi` INT(2) NOT NULL AUTO_INCREMENT,
  `nm_areaTi` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`cd_areaTi`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`deficiencia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`deficiencia` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`deficiencia` (
  `cd_deficiencia` INT(1) NOT NULL AUTO_INCREMENT,
  `nm_deficiencia` VARCHAR(20) NOT NULL,
  PRIMARY KEY (`cd_deficiencia`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
--
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`estado`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`estado` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`estado` (
  `cd_estado` INT(2) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`cidade`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`cidade` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`cidade` (
  `cd_cidade` INT(4) NOT NULL AUTO_INCREMENT,
  `nm_cidade` VARCHAR(45) NOT NULL,
  `fk_estado` INT(2) NOT NULL,
  PRIMARY KEY (`cd_cidade`),
  INDEX `fk_cidade_estado1_idx` (`fk_estado` ASC),
  CONSTRAINT `fk_cidade_estado1`
    FOREIGN KEY (`fk_estado`)
    REFERENCES `id5607506_employtecdb`.`estado` (`cd_estado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`users` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`users` (
  ...
  `ds_complemento` VARCHAR(50) NULL DEFAULT NULL,
  `nr_tel` INT(11) NULL DEFAULT NULL,
  `nl_user` INT(1) NOT NULL,
  `nr_cel` INT(11) NULL DEFAULT NULL,
  `im_perfil` VARCHAR(250) NULL DEFAULT NULL,
  `link_linkedin` VARCHAR(45) NULL DEFAULT NULL,
  `link_facebook` VARCHAR(45) NULL DEFAULT NULL,
  `link_twitter` VARCHAR(45) NULL DEFAULT NULL,
  `link_site` VARCHAR(45) NULL DEFAULT NULL,
  `fk_cidade` INT(4) NULL DEFAULT NULL,
  `ic_ativo` TINYINT(1) NULL DEFAULT 1,
  `created_at` DATE NULL DEFAULT NULL,
  `update_at` DATE NULL DEFAULT NULL,
  `remember_token` VARCHAR(250) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_users_cidade1_idx` (`fk_cidade` ASC),
  CONSTRAINT `fk_users_cidade1`
    FOREIGN KEY (`fk_cidade`)
    REFERENCES `id5607506_employtecdb`.`cidade` (`cd_cidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`candidato`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`candidato` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`candidato` (
  `cd_cpf` VARCHAR(11) NOT NULL,
  `ds_estado_civil` VARCHAR(10) NOT NULL,
  `ic_genero` ENUM('Feminino', 'Masculino', 'Outros') NOT NULL,
  `dt_nascimento` DATE NOT NULL,
  `ds_nacionalidade` VARCHAR(20) NULL DEFAULT 'Brasil',
  `nm_candidato` VARCHAR(45) NOT NULL,
  `fk_usuario` INT(7) NOT NULL,
  `fk_deficiencia` INT(1) NULL DEFAULT NULL,
  PRIMARY KEY (`cd_cpf`),
  INDEX `fk_candidato_usuario_idx` (`fk_usuario` ASC),
  INDEX `fk_candidato_defeciencia_idx` (`fk_deficiencia` ASC),
  CONSTRAINT `fk_candidato_defeciencia`
    FOREIGN KEY (`fk_deficiencia`)
    REFERENCES `id5607506_employtecdb`.`deficiencia` (`cd_deficiencia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_candidato_usuario`
    FOREIGN KEY (`fk_usuario`)
    REFERENCES `id5607506_employtecdb`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`curriculo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`curriculo` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`curriculo` (
  `cd_curriculo` INT(6) NOT NULL AUTO_INCREMENT,
  `ds_objetivo_profissional` VARCHAR(100) NOT NULL,
  `vl_prentencao_salarial` DECIMAL(7,2) NULL DEFAULT NULL,
  `ds_info_complementar` VARCHAR(250) NULL DEFAULT NULL,
  `ds_resumo_profissional` LONGTEXT NULL DEFAULT NULL,
  `fk_candidato` VARCHAR(11) NOT NULL,
  PRIMARY KEY (`cd_curriculo`),
  INDEX `fk_curriculo_candidato_idx` (`fk_candidato` ASC),
  CONSTRAINT `fk_curriculo_candidato`
    FOREIGN KEY (`fk_candidato`)
    REFERENCES `id5607506_employtecdb`.`candidato` (`cd_cpf`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`empresa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`empresa` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`empresa` (
  `cd_cnpj` VARCHAR(14) NOT NULL,
  `ds_razao_social` VARCHAR(30) NOT NULL,
  `fk_usuario` INT(7) NOT NULL,
  PRIMARY KEY (`cd_cnpj`),
  INDEX `fk_empresa_usuario_idx` (`fk_usuario` ASC),
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`experiencia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`experiencia` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`experiencia` (
  `cd_experiencia` INT(6) NOT NULL AUTO_INCREMENT,
  `nm_cargo_experiencia` VARCHAR(30) NOT NULL,
  `ds_experiencia` LONGTEXT NOT NULL,
  `nm_empresa` VARCHAR(20) NOT NULL,
  `ds_segmento_empresa` VARCHAR(25) NULL DEFAULT NULL,
  `vl_salario` DOUBLE(10,2) NULL,
  `dt_inicio_experiencia` DATE NOT NULL,
  `dt_termino_experiencia` DATE NULL,
  `fk_candidato` VARCHAR(11) NOT NULL,
  PRIMARY KEY (`cd_experiencia`),
  INDEX `fk_historico_candidato_idx` (`fk_candidato` ASC),
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`perfil_vaga`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`perfil_vaga` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`perfil_vaga` (
  `cd_perfil_vaga` INT(6) NOT NULL AUTO_INCREMENT,
  `nm_perfil_vaga` VARCHAR(20) NOT NULL,
  `ds_genero` VARCHAR(20) NOT NULL,
  `nr_idade` INT(3) NOT NULL,
  `ds_interresse` MEDIUMTEXT NULL DEFAULT NULL,
  `ds_formacao` VARCHAR(250) NOT NULL,
  PRIMARY KEY (`cd_perfil_vaga`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;


-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`pergunta`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`pergunta` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`pergunta` (
  `cd_pergunta` INT(4) NOT NULL AUTO_INCREMENT,
  `ds_pergunta` VARCHAR(60) NOT NULL,
  `fk_areaTI` INT(2) NOT NULL,
  PRIMARY KEY (`cd_pergunta`),
  INDEX `fk_pergunta_areaTI_idx` (`fk_areaTI` ASC),
  CONSTRAINT `fk_pergunta_areaTI`
    FOREIGN KEY (`fk_areaTI`)
    REFERENCES `id5607506_employtecdb`.`area_ti` (`cd_areaTi`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`alternativa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`alternativa` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`alternativa` (
  `cd_alternativa` INT(6) NOT NULL AUTO_INCREMENT,
  `ds_alternativa` MEDIUMTEXT NOT NULL,
  `ic_alternativa` TINYINT NOT NULL,
  `fk_pergunta` INT(4) NOT NULL,
  PRIMARY KEY (`cd_alternativa`),
  INDEX `fk_alternativa_pergunta1_idx` (`fk_pergunta` ASC),
  CONSTRAINT `fk_alternativa_pergunta1`
    FOREIGN KEY (`fk_pergunta`)
    REFERENCES `id5607506_employtecdb`.`pergunta` (`cd_pergunta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`resposta`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`resposta` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`resposta` (
  `cd_resposta` INT(6) NOT NULL AUTO_INCREMENT,
  `alternativa_candidato` VARCHAR(45) NULL DEFAULT NULL,
  `dt_realizado` DATE NOT NULL,
  `fk_alternativa` INT(6) NOT NULL,
  PRIMARY KEY (`cd_resposta`),
  INDEX `fk_respostas_alternativa1_idx` (`fk_alternativa` ASC),
  CONSTRAINT `fk_respostas_alternativa1`
    FOREIGN KEY (`fk_alternativa`)
    REFERENCES `id5607506_employtecdb`.`alternativa` (`cd_alternativa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`vaga`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`vaga` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`vaga` (
  `cd_vaga` INT(6) NOT NULL AUTO_INCREMENT,
  `nm_vaga` VARCHAR(30) NOT NULL,
  `ds_nivel` VARCHAR(20) NOT NULL,
  `dt_expiracao` DATE NOT NULL,
  `qt_vagas` INT(3) NOT NULL,
  `vl_salario_vaga` DOUBLE(7,2) NULL DEFAULT NULL,
  `nm_contratacao` VARCHAR(20) NOT NULL,
  `fk_empresa` VARCHAR(14) NOT NULL,
  `fk_area_ti` INT(2) NOT NULL,
  `fk_cidade` INT(4) NOT NULL,
  `ic_vale_transporte` TINYINT(1) NULL DEFAULT 0,
  `ic_vale_alimentacao` TINYINT(1) NULL DEFAULT 0,
  `ic_plano_saude` TINYINT(1) NULL DEFAULT 0,
  `ic_plano_dentario` TINYINT(1) NULL DEFAULT 0,
  `ic_seguro_vida` TINYINT(1) NULL DEFAULT 0,
  `fk_perfil_vaga` INT(6) NOT NULL,
  PRIMARY KEY (`cd_vaga`),
  INDEX `fk_vaga_empresa_idx` (`fk_empresa` ASC),
  INDEX `fk_vaga_area_idx` (`fk_area_ti` ASC),
  INDEX `fk_vaga_cidade1_idx` (`fk_cidade` ASC),
  INDEX `fk_vaga_perfil_vaga1_idx` (`fk_perfil_vaga` ASC),
  CONSTRAINT `fk_vaga_area`
    FOREIGN KEY (`fk_area_ti`)
    REFERENCES `id5607506_employtecdb`.`area_ti` (`cd_areaTi`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vaga_empresa`
    FOREIGN KEY (`fk_empresa`)
    REFERENCES `id5607506_employtecdb`.`empresa` (`cd_cnpj`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vaga_cidade1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_vaga_perfil_vaga1`
    FOREIGN KEY (`fk_perfil_vaga`)
    REFERENCES `id5607506_employtecdb`.`perfil_vaga` (`cd_perfil_vaga`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`idioma`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`idioma` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`idioma` (
  `cd_idioma` INT(2) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`curriculo_idiomas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`curriculo_idiomas` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`curriculo_idiomas` (
  ...
  PRIMARY KEY (`fk_curriculo`, `fk_idioma`),
  INDEX `fk_curriculo_has_idiomas_idiomas1_idx` (`fk_idioma` ASC),
  INDEX `fk_curriculo_has_idiomas_curriculo1_idx` (`fk_curriculo` ASC),
  CONSTRAINT `fk_curriculo_has_idiomas_curriculo1`
    FOREIGN KEY (`fk_curriculo`)
    REFERENCES `id5607506_employtecdb`.`curriculo` (`cd_curriculo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_curriculo_has_idiomas_idiomas1`
    FOREIGN KEY (`fk_idioma`)
    REFERENCES `id5607506_employtecdb`.`idioma` (`cd_idioma`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`pergunta_candidato`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`pergunta_candidato` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`pergunta_candidato` (
  `fk_pergunta` INT(4) NOT NULL,
  `fk_cpf` VARCHAR(11) NOT NULL,
  PRIMARY KEY (`fk_pergunta`, `fk_cpf`),
  INDEX `fk_pergunta_has_candidato_candidato1_idx` (`fk_cpf` ASC),
  INDEX `fk_pergunta_has_candidato_pergunta1_idx` (`fk_pergunta` ASC),
  CONSTRAINT `fk_pergunta_has_candidato_pergunta1`
    FOREIGN KEY (`fk_pergunta`)
    REFERENCES `id5607506_employtecdb`.`pergunta` (`cd_pergunta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pergunta_has_candidato_candidato1`
    FOREIGN KEY (`fk_cpf`)
    REFERENCES `id5607506_employtecdb`.`candidato` (`cd_cpf`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`candidato_vaga`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`candidato_vaga` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`candidato_vaga` (
  `fk_candidato` VARCHAR(11) NOT NULL,
  `fk_vaga` INT(6) NOT NULL,
  PRIMARY KEY (`fk_candidato`, `fk_vaga`),
  INDEX `fk_candidato_has_vaga_vaga1_idx` (`fk_vaga` ASC),
  INDEX `fk_candidato_has_vaga_candidato1_idx` (`fk_candidato` ASC),
  ...
  CONSTRAINT `fk_candidato_has_vaga_vaga1`
    FOREIGN KEY (`fk_vaga`)
    REFERENCES `id5607506_employtecdb`.`vaga` (`cd_vaga`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `id5607506_employtecdb`.`formacao_academica`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id5607506_employtecdb`.`formacao_academica` ;

CREATE TABLE IF NOT EXISTS `id5607506_employtecdb`.`formacao_academica` (
  `cd_formacao_academica` INT(11) NOT NULL AUTO_INCREMENT,
  `nm_curso` VARCHAR(50) NULL DEFAULT NULL,
  `nm_universidade` VARCHAR(45) NULL DEFAULT NULL,
  `tp_formacao` VARCHAR(30) NULL DEFAULT NULL,
  `nr_semestre` INT(1) NULL DEFAULT NULL,
  `qt_duracao` INT(1) NULL DEFAULT NULL,
  `dt_inicio` DATE NULL DEFAULT NULL,
  `dt_conclusao` DATE NULL DEFAULT NULL,
  `fk_candidato` VARCHAR(11) NOT NULL,
  PRIMARY KEY (`cd_formacao_academica`),
  INDEX `fk_formacao_academica_candidato1_idx` (`fk_candidato` ASC),
