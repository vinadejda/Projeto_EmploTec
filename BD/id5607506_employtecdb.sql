...
--
-- Database: `id5607506_employtecdb`
--
...
CREATE TABLE `alternativa` (
  `cd_alternativa` int(6) NOT NULL,
  `ds_alternativa` mediumtext NOT NULL,
  `ic_alternativa` tinyint(4) NOT NULL,
  `fk_pergunta` int(4) NOT NULL
...
INSERT INTO `alternativa` (`cd_alternativa`, `ds_alternativa`, `ic_alternativa`, `fk_pergunta`) VALUES
(46, 'PHP 01', 1, 15),
(47, 'PHP 2', 0, 15),
(48, 'PHP 3', 0, 15),
(49, 'PHP 4', 0, 15),
...
--
-- Estrutura da tabela `area_ti`
--

CREATE TABLE `area_ti` (
  `cd_areaTI` int(2) NOT NULL,
  `nm_areaTI` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `area_ti`
--

INSERT INTO `area_ti` (`cd_areaTI`, `nm_areaTI`) VALUES
(1, 'Ruby on Rails'),
(2, 'PHP'),
(3, 'Java'),
(4, 'Javascript'),
...
CREATE TABLE `candidato` (
  ...
  `ic_genero` enum('Feminino','Masculino','Outros') NOT NULL,
  `dt_nascimento` date NOT NULL,
  `ds_nacionalidade` varchar(20) DEFAULT 'Brasil',
  `fk_usuario` int(7) NOT NULL,
  `fk_deficiencia` int(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `candidato` (`cd_cpf`, `ds_estado_civil`, `ic_genero`, `dt_nascimento`, `ds_nacionalidade`, `fk_usuario`, `fk_deficiencia`) VALUES
('11111111111', 'Solteiro', 'Feminino', '1998-10-11', NULL, 20, NULL),
('38274516800', 'Solteiro', 'Feminino', '1995-02-10', NULL, 3, NULL),
('38274516898', 'Solteiro', 'Feminino', '2018-05-23', NULL, 9, NULL),
('392487664', 'Casado', 'Feminino', '1998-10-11', 'Brasileira', 2, NULL);
...
CREATE TABLE `candidato_vaga` (
  `fk_candidato` varchar(11) NOT NULL,
  `fk_vaga` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `cidade` (`cd_cidade`, `nm_cidade`, `fk_estado`) VALUES
(1, 'Afonso Cláudio', 8),
...
CREATE TABLE `curriculo` (
  `cd_curriculo` int(6) NOT NULL,
  `ds_objetivo_profissional` varchar(100) NOT NULL,
  `vl_prentencao_salarial` decimal(7,2) DEFAULT NULL,
  `ds_info_complementar` varchar(250) DEFAULT NULL,
  `ds_resumo_profissional` longtext,
  `fk_candidato` varchar(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `curriculo` (`cd_curriculo`, `ds_objetivo_profissional`, `vl_prentencao_salarial`, `ds_info_complementar`, `ds_resumo_profissional`, `fk_candidato`) VALUES
(1, 'estagio ue', '20000.00', 'cafe coffee', 'se nao tiver café eu nem vou', '38274516898'),
(3, 'teste', '5.53', '54646', 'berwhtriotegewio', '392487664');

-- --------------------------------------------------------

--
-- Estrutura da tabela `curriculo_idiomas`
--

CREATE TABLE `curriculo_idiomas` (
  `fk_curriculo` int(6) NOT NULL,
  `fk_idioma` int(2) NOT NULL,
  `st_nivel_idioma` enum('Nativo','Iniciante','Intermediario','Avancado','Fluente') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `deficiencia` (
  `cd_deficiencia` int(1) NOT NULL,
  `nm_deficiencia` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `deficiencia` (`cd_deficiencia`, `nm_deficiencia`) VALUES
(1, 'Auditiva'),
(2, 'Intelectual'),
(3, 'Mental'),
(4, 'Motora'),
...
CREATE TABLE `empresa` (
  ...
  `ds_razao_social` varchar(30) NOT NULL,
  `fk_usuario` int(7) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `empresa` (`cd_cnpj`, `ds_razao_social`, `fk_usuario`) VALUES
('02222222222222', 'La Razione', 21),
('11111111100000', 'La Razion', 23),
('11111111111111', 'teste', 24),
('11111111111112', 'teste', 24),
('12345678901234', 'Razao Social', 4),
('12345678912345', 'Razao Social1', 27),
('3216549871234', 'Razao quase Suprema', 11);
...
CREATE TABLE `experiencia` (
  `cd_experiencia` int(6) NOT NULL,
  `nm_cargo_experiencia` varchar(30) NOT NULL,
  `ds_experiencia` longtext NOT NULL,
  `nm_empresa` varchar(20) NOT NULL,
  `ds_segmento_empresa` varchar(25) DEFAULT NULL,
  `vl_salario` double(10,2) DEFAULT NULL,
  `dt_inicio_experiencia` date NOT NULL,
  `dt_termino_experiencia` date DEFAULT NULL,
  `fk_candidato` varchar(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `experiencia` (`cd_experiencia`, `nm_cargo_experiencia`, `ds_experiencia`, `nm_empresa`, `ds_segmento_empresa`, `vl_salario`, `dt_inicio_experiencia`, `dt_termino_experiencia`, `fk_candidato`) VALUES
(1, 'Estagio', 'fazia qualquer coisa', 'sla', 'teste', 1500.00, '2017-05-12', NULL, '38274516898'),
(2, 'teste', 'teste', 'teste', 'teste', 54544.54, '2018-05-19', NULL, '392487664');
...
CREATE TABLE `formacao_academica` (
  `cd_formacao_academica` int(11) NOT NULL,
  `nm_curso` varchar(50) DEFAULT NULL,
  `nm_universidade` varchar(45) DEFAULT NULL,
  `tp_formacao` varchar(30) DEFAULT NULL,
  `nr_semestre` int(1) DEFAULT NULL,
  `qt_duracao` int(1) DEFAULT NULL,
...
--
-- Estrutura da tabela `perfil_vaga`
--

CREATE TABLE `perfil_vaga` (
  `cd_perfil_vaga` int(6) NOT NULL,
  `nm_perfil_vaga` varchar(20) NOT NULL,
  `ds_genero` varchar(20) NOT NULL,
  `nr_idade` int(3) NOT NULL,
  `ds_interresse` mediumtext,
  `ds_formacao` varchar(250) NOT NULL,
  `fk_vaga` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `pergunta` (
  `cd_pergunta` int(4) NOT NULL,
  `ds_pergunta` varchar(60) NOT NULL,
  `fk_areaTI` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estrutura da tabela `pergunta_candidato`
--

CREATE TABLE `pergunta_candidato` (
  `fk_pergunta` int(4) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `nl_user` int(1) NOT NULL,
  `nr_cel` varchar(12) DEFAULT NULL,
  `im_perfil` varchar(250) DEFAULT NULL,
  `link_linkedin` varchar(45) DEFAULT NULL,
  `link_facebook` varchar(45) DEFAULT NULL,
  `link_twitter` varchar(45) DEFAULT NULL,
  `link_site` varchar(45) DEFAULT NULL,
  `fk_cidade` int(4) DEFAULT NULL,
...
(6, 'Testes', 'teste@gmail.com', '$2y$10$gtZ2AZ2LsDikcaSBSKy5/.DOKvb8Mw.TDMTV/ZwThOdkVhBWYNvkm', 'teste', 10, 'teste', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL),
(7, 'Teste', 'teste@adminn.com', '$2y$10$IDfhpceP6sCV/oGdxBEHbuiT2jY7./YSlXAXIpEPYrgdxFVX60Bgm', 'teste', 10, 'teste', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL),
(8, 'Teste', 'teste@adminn.com', '$2y$10$hfqFHfEked6VP2tNiHycDuS9FhBu/94kPQqxtqjNzfgdAfnHhJTPa', 'teste', 10, 'teste', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL),
(9, 'Candidato qs Supremo', 'vi@quase.com', '$2y$10$Hj148IpTQy/T0o8ARR1HKutZD4BCfFcfDdx.PJkQszbRE2yCX4a1W', 'teste', 10, 'teste', NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, '8nsREcR0Cw5mK2U6qJVGxQR8Voxy7k3bd31jjSexDscbfwWNvqK2sYaO1J2F'),
(10, 'Candidato Validação', 'sem@validacao.com', '$2y$10$GS3j65DX2DkzThT1EDw.XefSYuzZ9ZaqiUqdZQO0VYHDNBFJ408iq', 'teste', 10, 'teste', NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'aLHUNPJmaSYbCGEHdrlg6L7MR4WlLZHjkWdHssYTiMM5bOJskzN9V2gTMrQe'),
(11, 'Empresa quase suprema', 'empresa@quase.com', '$2y$10$68mU7TZdUU/FD00j9zBXjOxcdm4.PaM8laMk/gMo/0zidqfIKO03O', 'Teste', 10, 'Teste', NULL, NULL, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, '3v40uQxfdupLGEzfUbZ08j19HtnEOfWdbAzVInMQ6FJYiDdpswm9nlVWh79s'),
(12, 'vitoria', 'teste1@gmail.com', '$2y$10$WzM3VUtHOeL0ABcCRS6HYeMieUImnHZ9SunXpf8VrkQagwWf5jym.', 'teste1', 10, 'teste1', 'teste1', NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'UyV4ZrZQAWrVst1kLBBKsrQf0WwzYARppX6JcVSzlVSmFj3ytRSvFVLSq14y'),
(13, 'Testedois', 'teste2@dois.com.br', '$2y$10$12voGyt5Jx2XGhEK3i/K2OobG84zJNksZOJLf511vFfecCSqbQ3ou', 'teste1', 45, 'tes2n2', 'sla09', NULL, 2, NULL, NULL, 'https://www.linkedin.com/feed/', NULL, NULL, NULL, NULL, 1, NULL, NULL, 'M7ijKNWO3zayFoH7OxEnMoUdBxUyc3cediARpttmPAqeFC3vfzXkEDhIMBad'),
(14, 'teste quatro', 'teste@teste.com', '$2y$10$E5FrScECnISLLbMr14CDhezepvAa/CPJqMtqQ3XMihDKBRG9cPw9u', 'teste 2', 12, 'teste', NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'mJq08Ss4oIGr5ShBGnfbUlstEe1yfxYhRQshDzVi44DRYju8UrPL0UlNexq8'),
(15, 'd\'agua teste', 'teste4@gmail.com', '$2y$10$BL3Sfz85TQ175IGN/9RgmeCjFdX9irBFu4jrSSkeV2HnfKt1.ooEu', 'teste teste', 10, 'teste', 'teste', NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'EEAovIuQdtGxQXb7n4DkjIcZ7PgLx1aynABn8SqrxIRbSfVpA8MHFh4HuRWc'),
(16, 'T\'este teste ok', 'teste-2@teste.ok', '$2y$10$TaZhyARCVrZCM4uIIXP9guCCw0RozKi/pBCy9ba7A71HCcnQJ1ho2', 'Teste ok 1', 14523, 'Teste', NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL),
(17, 'Teste d\'agua', 'teste@agua.com', '$2y$10$i5J24p3ZecJoqnk7X5vQy.ehI0brbslmv.8S90kEmWia9cFZAx6pm', 'teste', 10, 'teste', NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL),
(18, 'teste validação', 'val@teste.com', '$2y$10$eugMDMHeQJ6D9WPb4Q3RQ.8ex9jNBMnJqd1FRUviU04iKa2.mHNSK', 'TESTE VALIDacao', 10, 'validacao', 'TESTE VALIDAcao', NULL, 2, '0', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'YNGlzAPjqysR7OYiJ6x3PIWn4srf8EyTYT3MnpJgCm7e65qfOOn6zmeo8U5q'),
(19, 'teste validação', 'val2@teste.com', '$2y$10$1XQq4jkNcrfD/TwoTpLSBunlJfFghr5N8TN4g1n7CtDx8g2j4wEs.', 'teste validação', 10, 'teste', 'teste', '1111111111', 2, '11111111111', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'TGNVZVzLBduQwjd1dN22T2fRmpb8SGbJ4Vvy61zIowG9Ex3BXdxpTnsXnIvu'),
(20, 'Vitória Nadejda', 'vitoria@nadejda.com', '$2y$10$TN8XKglD3gAzHYEKSVCe7eXwaOXXiw8CmhO7KSN3/27NFrRml6Tkq', 'teste', 10, 'teste', 'teste', '1111111111', 2, '', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, '4dkaSiskaSgEYcRwQeDwF5tCQdLohl7VbwXG5moEn0SirE2IgzvXvcysfeMp'),
(21, 'F\'antasian', 'fantasia2@empresa.com', '$2y$10$Tom7/8g2gh4KZalSfx3jouoSCXa0vFdC6P20/lLNhgI66AliQMhVW', 'teste', 10, 'teste', NULL, '1111111111', 3, '', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 've5U3LZyEs37bBP0javuFyjzh9hROiDP9ERt545VHWfJp5QBisbMTCyAvJx9'),
(22, 'teste treêS', 'teste3@hotmail.com', '$2y$10$ktn/WsmDpiYwxZZADR5gsuIURo5fFt7JuPQpIpz74WZRc6QL6yhsG', 'teste', 10, 'teste', NULL, '1111111111', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL),
(23, 'La R\'azion', 'la@razion.com', '$2y$10$C.xTAvb3NscfCNgI.kMnw.CRH0im01unu1.arQZgFTKiQ91znY0JO', 'teste', 10, 'teste', NULL, '', 3, '', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, '9bgU2NdTpRTHlFw0CG8d2DQbx8nOUmPxnPtkcY0KFp3OqWCuzIqelvJo7WNF'),
(24, 'hey baby', 'baby@teste.com', '$2y$10$5wha.lXwKckNe9OwB1x5Y.C7x7ctUJelq9e1O4JbAQdA2g9DTvHXy', 'baby', 10, 'baby', NULL, '', 3, '', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL),
(25, 'teste 74521', 'admin@teste.com', '$2y$10$VUab.ip51bFTaLlmNj2zbOI4Ra.yFsi1TxZNc9Urffo7peXe3yCt2', 'teste com', 123, 'teste', NULL, '', 1, '', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL),
(26, 'teste validação okok', 'okok@okok.com', '$2y$10$nk2B.NP81r0jttHzNI0Mc.laHrZUGlrzn7swBlOwMvUrUgvHqmw8m', 'teste validação', 10, 'teste', NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'bkgTwFNvHLseb7jAoeRyPlOEjrcsjiamQMx8GpjyJGnDYHFS7NgkLbT2UeYW'),
(27, 'Empresa okok validação', 'okok@teste.com', '$2y$10$8JA09SskFomvOxFMDgSRqeLIL481vxJUF5rdd8beCl6gnF.4O3l72', 'teste validação', 10, 'validacao', 'teste validacaoo', '', 3, '', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'EPLAVaGSfY3hu1e7BBfebcGJ7ynhuwut8eF8Ip1BTJPqU17MmNjqndP5fdSo');
...
CREATE TABLE `vaga` (
  `cd_vaga` int(6) NOT NULL,
  `nm_vaga` varchar(30) NOT NULL,
  `ds_nivel` varchar(20) NOT NULL,
  `dt_expiracao` date NOT NULL,
  `qt_vagas` int(3) NOT NULL,
  `vl_salario_vaga` double(7,2) DEFAULT NULL,
  `nm_contratacao` varchar(20) NOT NULL,
  `fk_empresa` varchar(14) NOT NULL,
  `fk_area_ti` int(2) NOT NULL,
  `fk_cidade` int(4) NOT NULL,
  `ic_vale_transporte` tinyint(1) DEFAULT '0',
  `ic_vale_alimentacao` tinyint(1) DEFAULT '0',
  `ic_plano_saude` tinyint(1) DEFAULT '0',
  `ic_plano_dentario` tinyint(1) DEFAULT '0',
  `ic_seguro_vida` tinyint(1) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `vaga` (`cd_vaga`, `nm_vaga`, `ds_nivel`, `dt_expiracao`, `qt_vagas`, `vl_salario_vaga`, `nm_contratacao`, `fk_empresa`, `fk_area_ti`, `fk_cidade`, `ic_vale_transporte`, `ic_vale_alimentacao`, `ic_plano_saude`, `ic_plano_dentario`, `ic_seguro_vida`) VALUES
(1, 'Estagio em PHP', 'Estágio', '2018-05-10', 2, 1500.00, 'CLT', '12345678901234', 2, 1, 1, 1, 0, 0, 0),
(2, 'Trainee', 'Trainne', '2018-05-11', 3, 1000.00, 'PJ', '12345678901234', 5, 69, 1, 0, 0, 1, 0),
(3, 'Estágio em SQL', 'Estágio', '2018-06-08', 1, 2000.00, 'PJ', '12345678901234', 16, 19, 1, 1, 0, 0, 0),
(4, 'Estágio ASP NET', 'Estágio', '2018-06-04', 4, 800.00, 'CLT', '12345678901234', 6, 930, 1, 1, 0, 0, 0),
(5, 'Trainee NodeJS', 'Trainne', '2018-05-20', 1, 1500.00, 'CLT', '3216549871234', 8, 96, 1, 1, 1, 0, 0);
...
ALTER TABLE `alternativa`
  ...
  ADD KEY `fk_alternativa_pergunta1_idx` (`fk_pergunta`);

--
-- Indexes for table `area_ti`
--
ALTER TABLE `area_ti`
  ADD PRIMARY KEY (`cd_areaTI`);

--
-- Indexes for table `candidato`
--
ALTER TABLE `candidato`
  ADD PRIMARY KEY (`cd_cpf`),
  ADD KEY `fk_candidato_usuario_idx` (`fk_usuario`),
  ADD KEY `fk_candidato_defeciencia_idx` (`fk_deficiencia`);

--
-- Indexes for table `candidato_vaga`
--
ALTER TABLE `candidato_vaga`
  ADD PRIMARY KEY (`fk_candidato`,`fk_vaga`),
  ADD KEY `fk_candidato_has_vaga_vaga1_idx` (`fk_vaga`),
  ADD KEY `fk_candidato_has_vaga_candidato1_idx` (`fk_candidato`);
...
ALTER TABLE `cidade`
  ...
  ADD KEY `fk_cidade_estado1_idx` (`fk_estado`);
...
ALTER TABLE `curriculo`
  ...
  ADD KEY `fk_curriculo_candidato_idx` (`fk_candidato`);

--
-- Indexes for table `curriculo_idiomas`
--
ALTER TABLE `curriculo_idiomas`
  ADD PRIMARY KEY (`fk_curriculo`,`fk_idioma`),
  ADD KEY `fk_curriculo_has_idiomas_idiomas1_idx` (`fk_idioma`),
  ADD KEY `fk_curriculo_has_idiomas_curriculo1_idx` (`fk_curriculo`);

--
-- Indexes for table `deficiencia`
--
ALTER TABLE `deficiencia`
  ADD PRIMARY KEY (`cd_deficiencia`);
...
ALTER TABLE `empresa`
  ...
  ADD KEY `fk_empresa_usuario_idx` (`fk_usuario`);
...
ALTER TABLE `experiencia`
  ADD PRIMARY KEY (`cd_experiencia`),
  ADD KEY `fk_historico_candidato_idx` (`fk_candidato`);

--
-- Indexes for table `formacao_academica`
--
ALTER TABLE `formacao_academica`
  ADD PRIMARY KEY (`cd_formacao_academica`),
  ADD KEY `fk_formacao_academica_candidato1_idx` (`fk_candidato`);
...
--
-- Indexes for table `perfil_vaga`
--
ALTER TABLE `perfil_vaga`
  ADD PRIMARY KEY (`cd_perfil_vaga`);
...
ALTER TABLE `pergunta`
  ...
  ADD KEY `fk_pergunta_areaTI_idx` (`fk_areaTI`);
...
ALTER TABLE `users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_users_cidade1_idx` (`fk_cidade`);
...
ALTER TABLE `vaga`
  ...
  ADD KEY `fk_vaga_empresa_idx` (`fk_empresa`),
  ADD KEY `fk_vaga_area_idx` (`fk_area_ti`),
  ADD KEY `fk_vaga_cidade1_idx` (`fk_cidade`);
...
--
ALTER TABLE `area_ti`
  MODIFY `cd_areaTI` int(2) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `cidade`
--
ALTER TABLE `cidade`
  MODIFY `cd_cidade` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5565;

--
-- AUTO_INCREMENT for table `curriculo`
--
ALTER TABLE `curriculo`
  MODIFY `cd_curriculo` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `deficiencia`
--
ALTER TABLE `deficiencia`
  MODIFY `cd_deficiencia` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `estado`
--
ALTER TABLE `estado`
  MODIFY `cd_estado` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `experiencia`
--
ALTER TABLE `experiencia`
  MODIFY `cd_experiencia` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `formacao_academica`
--
ALTER TABLE `formacao_academica`
  MODIFY `cd_formacao_academica` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `idioma`
--
ALTER TABLE `idioma`
  MODIFY `cd_idioma` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `perfil_vaga`
--
ALTER TABLE `perfil_vaga`
  MODIFY `cd_perfil_vaga` int(6) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `vaga`
  MODIFY `cd_vaga` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `alternativa`
  ADD CONSTRAINT `fk_alternativa_pergunta1` FOREIGN KEY (`fk_pergunta`) REFERENCES `pergunta` (`cd_pergunta`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `candidato`
--
ALTER TABLE `candidato`
  ADD CONSTRAINT `fk_candidato_defeciencia` FOREIGN KEY (`fk_deficiencia`) REFERENCES `deficiencia` (`cd_deficiencia`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_candidato_usuario` FOREIGN KEY (`fk_usuario`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `candidato_vaga`
--
ALTER TABLE `candidato_vaga`
  ADD CONSTRAINT `fk_candidato_has_vaga_candidato1` FOREIGN KEY (`fk_candidato`) REFERENCES `candidato` (`cd_cpf`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_candidato_has_vaga_vaga1` FOREIGN KEY (`fk_vaga`) REFERENCES `vaga` (`cd_vaga`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `cidade`
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `fk_cidade_estado1` FOREIGN KEY (`fk_estado`) REFERENCES `estado` (`cd_estado`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `curriculo`
--
ALTER TABLE `curriculo`
  ADD CONSTRAINT `fk_curriculo_candidato` FOREIGN KEY (`fk_candidato`) REFERENCES `candidato` (`cd_cpf`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `curriculo_idiomas`
--
ALTER TABLE `curriculo_idiomas`
  ADD CONSTRAINT `fk_curriculo_has_idiomas_curriculo1` FOREIGN KEY (`fk_curriculo`) REFERENCES `curriculo` (`cd_curriculo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_curriculo_has_idiomas_idiomas1` FOREIGN KEY (`fk_idioma`) REFERENCES `idioma` (`cd_idioma`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `empresa`
--
ALTER TABLE `empresa`
  ADD CONSTRAINT `fk_empresa_usuario` FOREIGN KEY (`fk_usuario`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `experiencia`
--
ALTER TABLE `experiencia`
  ADD CONSTRAINT `fk_historico_candidato` FOREIGN KEY (`fk_candidato`) REFERENCES `candidato` (`cd_cpf`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `formacao_academica`
--
ALTER TABLE `formacao_academica`
  ADD CONSTRAINT `fk_formacao_academica_candidato1` FOREIGN KEY (`fk_candidato`) REFERENCES `candidato` (`cd_cpf`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `pergunta`
--
ALTER TABLE `pergunta`
  ADD CONSTRAINT `fk_pergunta_areaTI` FOREIGN KEY (`fk_areaTI`) REFERENCES `area_ti` (`cd_areaTi`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `fk_users_cidade1` FOREIGN KEY (`fk_cidade`) REFERENCES `cidade` (`cd_cidade`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `vaga`
--
ALTER TABLE `vaga`
  ADD CONSTRAINT `fk_vaga_area` FOREIGN KEY (`fk_area_ti`) REFERENCES `area_ti` (`cd_areaTi`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_vaga_cidade1` FOREIGN KEY (`fk_cidade`) REFERENCES `cidade` (`cd_cidade`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_vaga_empresa` FOREIGN KEY (`fk_empresa`) REFERENCES `empresa` (`cd_cnpj`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
