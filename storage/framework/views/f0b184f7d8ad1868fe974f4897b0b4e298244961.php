                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <?php elseif(auth()->guard('admin')->check()): ?>
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item" href="<?php echo e(route('dashboard-admin')); ?>">
                                                    <?php echo e(__('Área do Administrador')); ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <!--<li-->
                                            <!--<a href="<?php echo e(route('register')); ?>" class="nav-link btn btn-outline-light top-btn">
                                                <span class="ti-plus"></span><?php echo e(__('CADASTRE-SE')); ?> 
                                            </a>-->
                                            <!--<a href="#" class="nav-link" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <span class="ti-plus icon-arrow-down"></span><?php echo e(__('CADASTRE-SE')); ?> 
                                            </a>
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                                <a class="dropdown-item" href="<?php echo e(route('register')); ?>">Candidato</a>
                                                <a class="dropdown-item" href="<?php echo e(route('empresa.register')); ?>">Empresa</a>
