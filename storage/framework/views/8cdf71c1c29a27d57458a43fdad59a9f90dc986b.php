                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(!auth()->guard('empresa')->check()): ?>
                            <li><a class="nav-link" href="<?php echo e(route('empresa.login')); ?>"><?php echo e(__('Login')); ?></a></li>
                            <li><a class="nav-link" href="<?php echo e(route('empresa.register')); ?>"><?php echo e(__('Register')); ?></a></li>
                        <?php else: ?>
