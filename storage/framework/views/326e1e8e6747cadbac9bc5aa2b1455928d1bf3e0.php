    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            -->
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i><?php echo e(Auth::guard('empresa')->user()->name); ?> <i class="fa fa-caret-down"></i>
                    </a>
            ...
            <div class="navbar-default sidebar" role="navigation" style="margin-top: 6.2%;>
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo e(route('dashboard-empresa')); ?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/painel/empresa/vagas')); ?>"><i class="fa  fa-crosshairs fa-fw"></i> Vagas</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/painel/empresa/perfil')); ?>"><i class="fa  fa-bullseye  fa-fw"></i> Perfil das Vagas</a>
                        </li>
                        <li>
