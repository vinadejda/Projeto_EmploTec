...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar" role="navigation" style="margin-top: 6%;">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo e(url('/painel/candidato/curriculo')); ?>"><i class="fa  fa-crosshairs fa-fw"></i> Curriculo</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/painel/candidato/experiencia')); ?>"><i class="fa fa-bar-chart-o fa-fw"></i> Experiências Relevantes</a>
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Seja Bem-Vind@, <?php echo e(Auth::user()->name); ?>  </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
