        ...
        <form role="form" method="post" action="<?php echo e(isset($candidato) ? '/painel/candidato/dados/altera': '/painel/candidato/dados/salva'); ?>">
          <fieldset>
            ...
            <div class="form-group col-md-3">
              ...
              <input type="text" name="cpf" class="form-control" placeholder="Digite seu CPF" required value="<?php echo e(isset($candidato) ? $candidato->cd_cpf : old('cpf')); ?>" 
            ...
            <div class="form-group col-md-3">
              ...
              <input type="date" name="dt_nascimento" class="form-control" required="required" value="<?php echo e(isset($candidato) ? $candidato->dt_nascimento : old('dt_nascimento')); ?>">
            </div>
            ...
            <div class="form-group col-md-3">
              ...
              <input type="text" name="nacionalidade" class="form-control" placeholder="Digite sua nacionalidade" value="<?php echo e(isset($candidato) ? $candidato->ds_nacionalidade : old('nacionalidade')); ?>">
            </div>
