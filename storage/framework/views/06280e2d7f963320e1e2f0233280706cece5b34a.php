...
<head>
    ...
    <title><?php echo e(__('EmployTec - Area do Usuario')); ?></title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <img  width="16%;" src="<?php echo e(asset('../../images/logo.png')); ?>">
                </a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation" style="margin-top: 6.2%;">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo e(url('/painel/candidato/dashboard')); ?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/painel/candidato/curriculo/informacoes')); ?>"><i class="fa  fa-crosshairs fa-fw"></i> Curriculo</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/painel/candidato/experiencia/informacoes')); ?>"><i class="fa fa-bar-chart-o fa-fw"></i> Experiências Relevantes</a>
                        </li>
                        ...
                        <li>
                            <a href="<?php echo e(url('/painel/candidato/dados/informacoes')); ?>"><i class="fa fa-edit fa-fw"></i> Dados Pessoais</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Seja Bem-Vindo(a), <?php echo e(Auth::user()->name); ?>  </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
