                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" maxlength="45" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="text" maxlength="11"  class="form-control" name="celular" >
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="file" maxlength="250" class="form-control" name="img" >
                            </div>
                        </div>
                        <div class="form-group row">
