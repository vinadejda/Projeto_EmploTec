        ...
        action="{{isset($perfil) ? '/painel/empresa/perfil/altera': '/painel/empresa/perfil/adiciona'}}">
          <fieldset>
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" name="nome" class="form-control" placeholder="Nome do perfil" required value="{{isset($perfil) ? $perfil->nm_perfil_vaga : old('nome')}}">
            </div>
            ...
            <div class="form-group col-md-12">
              ...
              <textarea name="competencia" class="form-control" placeholder="Digite as competências desejadas" rows="2" >{{isset($perfil) ? $perfil->ds_interresse : old('competencia')}}</textarea>
            </div>
          </fieldset>
