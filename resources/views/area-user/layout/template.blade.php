            ...
            <div class="navbar-default sidebar" role="navigation" style="margin-top: 6.2%;">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{url('/painel/candidato/curriculo/informacoes')}}"><i class="fa  fa-crosshairs fa-fw"></i> Curriculo</a>
                        </li>
                        <li>
                            <a href="{{url('/painel/candidato/experiencia/informacoes')}}"><i class="fa fa-bar-chart-o fa-fw"></i> Experiências Relevantes</a>
                        </li>
