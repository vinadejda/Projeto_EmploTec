...
<head>
    ...
    <title>{{ __('EmployTec - Area do Usuario') }}</title>
            ...
            <div class="navbar-default sidebar" role="navigation" style="margin-top: 6%;">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ url('/painel/candidato/dashboard') }}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="{{url('/painel/candidato/curriculo')}}"><i class="fa  fa-crosshairs fa-fw"></i> Curriculo</a>
                        </li>
                        <li>
                            <a href="{{url('/painel/candidato/experiencia')}}"><i class="fa fa-bar-chart-o fa-fw"></i> Experiências Relevantes</a>
                        </li>
